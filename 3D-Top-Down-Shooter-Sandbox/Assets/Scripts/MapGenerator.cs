...
public class MapGenerator : MonoBehaviour {
    ...
    //Function to spawn the player randomly
    void SpawnPlayerRandomly()
    {
        ...
        while(!isSpawned)
        {
            int xPlayerPos = UnityEngine.Random.Range(0, width);
            int zPlayerPos = UnityEngine.Random.Range(0, height);

            if(map[xPlayerPos, zPlayerPos] == 0)
            {
